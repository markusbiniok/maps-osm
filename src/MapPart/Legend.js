...
function Legend() {
    ...
    <div className='legend'>
      ...
      <div className='pathOptions'>
        ...
        <div id='span2'/><div id='p2'>gemeinsamer Rad- und Fußweg</div> 
        <div id='span3'>
      ...
      <div className='heatmap'>
        <div id='high'/><div id='textHigh'>hohe Auslastung</div>
        <div id='middle'/><div id='textMiddle'>mittlere Auslastung</div>   
        <div id='low'/><div id='textLow'>niedrige Auslastung</div>                
      </div>
      <p id='ut'>Links</p>
      <div className='hyperlink'>
        <a id='link1' href="https://geoportal.leipzig.de/arcgis/apps/experiencebuilder/experience/?id=4fd2c688fa754d55903dcb8acf9dafa7&page=page_0" target='_blank' rel='noopener noreferrer'>Dauerzählstellen Stadt Leipzig</a>                    
      </div>
    </div>
    )
}
